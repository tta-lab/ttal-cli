...
- **ttal explore** — research context for writing:
  - `ttal explore "question" --url https://example.com` — explore web pages
  - `ttal explore "question" --web` — search the web (what's trending, what tags work)
  - `ttal explore "question" --repo org/repo` — explore OSS repos for technical posts
