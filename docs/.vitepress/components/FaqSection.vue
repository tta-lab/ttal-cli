...
const faqs = [
  ...
  },
  {
    ...
    a: 'Claude Code (stable), OpenCode and Codex CLI (experimental). You can mix runtimes across your team — run managers on Claude Code and workers on Codex, or any combination.',
  },
  {
