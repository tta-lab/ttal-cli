...
- If the worker genuinely can't do the Category 2 item for reasons outside their control → escalate to Neil via heredoc to `ttal send --to neil`. Don't downgrade to non-blocking to paper over it.
